...
- [ ] **0.2 Esqueleto do app.** Next.js + TypeScript, `design/tokens.css` global, fontes Geist, tema claro/escuro com alternância salva no navegador, cliente Supabase lendo `.env.local`.
...
- [ ] **0.6 RLS e login.** Supabase Auth; RLS por papel lido de `painel_usuarios`; um usuário de cada papel para teste.
...
- [ ] **1.4 Interno Planee.** Custo por dia, cache e fallback, falhas, alertas.
...
- [ ] 5.1 Registro de clientes, subdomínio por cliente, SSA no mesmo app.
